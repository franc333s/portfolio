        ...
        <>
         <main className="vertical-padding">
            ...
            <section className="home-intro">
                <p className="home-intro__text p--main text-color-black" id="intro-section">I’m an ex-industrial designer who developed a professional career in project management at digital agencies. Currently <strong>coding cool projects</strong> for awesome people.</p>
